...
#define T2HeaterRelay 16  // T2 Heat DB9 pin 8 white wire Arduino Digital I/O pin number 15
#define T2ChillRelay  23 // T2 Heat DB9 pin 2 red wire Arduino Digital I/O pin number 24
#define T3HeaterRelay 15  // T3 Heat DB9 pin 7 purple wire Arduino Digital I/O pin number 16
#define T3ChillRelay  24  // T3 Chill DB9 pin 3 orange Arduino Digital I/O pin number 23
#define T4HeaterRelay 14 // T4 Heat DB9 pin 6 blue wire Arduino Digital I/O pin number 25
#define T4ChillRelay  25  // T4 Chill DB9 pin 4 yellow wire Arduino Digital I/O pin number 14
